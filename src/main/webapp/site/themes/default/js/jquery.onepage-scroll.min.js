...
function(e) {
    ...
    e.fn.onepage_scroll = function(n) {
        ...
        e.fn.transformPage = function(t, n, r) {
            ...
            //头部修改
			var scrollheight = 121/$(window).height() * 100;
            n = n - scrollheight;
        	if(r ==1 ){
				console.log(r);
        		n = n + scrollheight;
				//$(".onepage-wrapper").css("height",$(window).height()-121+'px');
				//$(".page1").css("height",$(window).height()-121+'px');
        	}else{
				//$(".onepage-wrapper").css("height",$(window).height()+'px');
			}
			...
			//var scremheight = window.outerHeight;
            // e(this).css({
              //  "-webkit-transform": t.direction == "horizontal" ? "translate3d(" + scremheight + "px, 0, 0)": "translate3d(0, " + scremheight + "px, 0)",
                //"-webkit-transition": "all " + t.animationTime + "ms " + t.easing,
                //"-moz-transform": t.direction == "horizontal" ? "translate3d(" + scremheight + "px, 0, 0)": "translate3d(0, " + scremheight + "px, 0)",
                //"-moz-transition": "all " + t.animationTime + "ms " + t.easing,
                //"-ms-transform": t.direction == "horizontal" ? "translate3d(" + scremheight + "px, 0, 0)": "translate3d(0, " + scremheight + "px, 0)",
                //"-ms-transition": "all " + t.animationTime + "ms " + t.easing,
                //transform: t.direction == "horizontal" ? "translate3d(" + scremheight + "px, 0, 0)": "translate3d(0, " + scremheight + "px, 0)",
                //transition: "all " + t.animationTime + "ms " + t.easing
            //});


            e(this).one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",
            function(e) {
