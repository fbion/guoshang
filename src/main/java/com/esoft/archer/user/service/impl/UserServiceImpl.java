...
public class UserServiceImpl implements UserService {
    ...
    public void sendRegisterByMobileNumberYtxSMS(String mobileNumber) {
        ...
        messageBO.sendYtxSms(MessageConstants.YtxMessageTemplateId.USER_REGISTER_CODE, content, mobileNumber);
    }
    ...
    public void sendSuccessCreateYtxSMS(String username,String loanName,double money,String mobileNumber){
        ...
        messageBO.sendYtxSms(MessageConstants.YtxMessageTemplateId.LOAN_CREATE_SUCCESS, content, mobileNumber);
    }

    public void sendSuccessWithdrawYtxSMS(String username,double money,String mobileNumber){
        String[] content={username,String.valueOf(money)};
        messageBO.sendYtxSms(MessageConstants.YtxMessageTemplateId.WITHDRAW_CREATE_SUCCESS, content, mobileNumber);
    ...
    public void sendChangeBindingMobileNumberYtxSMS(String userId,
        ...
        String[] content={user.getUsername(),authService
                .createAuthInfo(
                        userId,
                        mobileNumber,
                        null,
                        CommonConstants.AuthInfoType.CHANGE_BINDING_MOBILE_NUMBER)
                .getAuthCode()};
        messageBO.sendYtxSms(MessageConstants.YtxMessageTemplateId.USER_CHANGE_MOBILE, content, mobileNumber);
    }
    ...
    public void sendSuccessRechargeByYtxSMS(String username,
        ...
        String[] content={username, DateUtil.DateToString(new Date(), DateStyle.YYYY_MM_DD_HH_MM_SS_CN),
                        String.valueOf(money)+"元",
                        String.valueOf(banlance)+"元"};
        messageBO.sendYtxSms(MessageConstants.YtxMessageTemplateId.USER_RECHARGE_SUCCESS, content, mobileNumber);
    }
